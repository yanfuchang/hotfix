...
class PreDexTransform extends Transform {
    ...
    PreDexTransform(Project project) {
        ...
        CodeInject.appendClassPath("D:\\AndroidStudioProjects\\hotfix\\app\\libs\\nowfix.jar")
    ...
    void transform(Context context, Collection<TransformInput> inputs,
        ...
        inputs.each { TransformInput input ->
            ...
            input.jarInputs.each {JarInput jarInput->
                ...
                System.out.println("处理jar包：" + jarName)
                def dest = outputProvider.getContentLocation(jarName+"_temp", jarInput.contentTypes, jarInput.scopes, Format.JAR)
